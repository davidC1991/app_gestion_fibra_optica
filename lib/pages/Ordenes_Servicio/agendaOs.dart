...
class _PantallaOrdenesServicioState extends State<PantallaOrdenesServicio> {
  ...
  Widget _crearBotonRedondeado(Color color,  DocumentSnapshot datoOs, BuildContext context, int i){
    ...
    return Column(
      ...
      children: [
        SingleChildScrollView(child: tarjetas(color, datoOs, imagen, context)),
        Divider()
      ],
    );
  }

  Container tarjetas(Color color, DocumentSnapshot datoOs, String imagen, BuildContext context) {
    final widthPantalla = MediaQuery.of(context).size.width;
